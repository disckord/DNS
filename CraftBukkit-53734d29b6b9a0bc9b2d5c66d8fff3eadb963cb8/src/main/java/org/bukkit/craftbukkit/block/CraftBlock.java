...
import net.minecraft.server.v1_5_R3.Direction;
...
public class CraftBlock implements Block {
    ...
    public int getBlockPower(BlockFace face) {
        int power = 0;
        BlockRedstoneWire wire = net.minecraft.server.v1_5_R3.Block.REDSTONE_WIRE;
        net.minecraft.server.v1_5_R3.World world = chunk.getHandle().world;
    ...
    private boolean itemCausesDrops(ItemStack item) {
        net.minecraft.server.v1_5_R3.Block block = net.minecraft.server.v1_5_R3.Block.byId[this.getTypeId()];
        net.minecraft.server.v1_5_R3.Item itemType = item != null ? net.minecraft.server.v1_5_R3.Item.byId[item.getTypeId()] : null;
            ...
            for (int i = 0; i < count; ++i) {
                ...
                if (item > 0) {
                    ...
                    if (net.minecraft.server.v1_5_R3.Block.SKULL.id == this.getTypeId()) {
                        net.minecraft.server.v1_5_R3.ItemStack nmsStack = new net.minecraft.server.v1_5_R3.ItemStack(item, 1, block.getDropData(chunk.getHandle().world, x, y, z));
