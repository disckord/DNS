...
public class CraftChunk implements Chunk {
    ...
    public CraftChunk(net.minecraft.server.v1_5_R3.Chunk chunk) {
    ...
    public net.minecraft.server.v1_5_R3.Chunk getHandle() {
        net.minecraft.server.v1_5_R3.Chunk c = weakChunk.get();

        if (c == null) {
            c = worldServer.getChunkAt(x, z);

            if (!(c instanceof EmptyChunk)) {
                weakChunk = new WeakReference<net.minecraft.server.v1_5_R3.Chunk>(c);
            }
        }
    ...
    public Entity[] getEntities() {
        int count = 0, index = 0;
        net.minecraft.server.v1_5_R3.Chunk chunk = getHandle();
