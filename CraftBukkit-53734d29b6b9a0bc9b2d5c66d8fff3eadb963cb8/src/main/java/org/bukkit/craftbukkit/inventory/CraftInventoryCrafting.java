...
public class CraftInventoryCrafting extends CraftInventory implements CraftingInventory {
    ...
    public ItemStack[] getContents() {
        ...
        net.minecraft.server.v1_5_R3.ItemStack[] mcResultItems = getResultInventory().getContents();
        ...
        net.minecraft.server.v1_5_R3.ItemStack[] mcItems = getMatrixInventory().getContents();
    ...
    public CraftItemStack getItem(int index) {
        if (index < getResultInventory().getSize()) {
            net.minecraft.server.v1_5_R3.ItemStack item = getResultInventory().getItem(index);
            return item == null ? null : CraftItemStack.asCraftMirror(item);
        } else {
            net.minecraft.server.v1_5_R3.ItemStack item = getMatrixInventory().getItem(index - getResultInventory().getSize());
            return item == null ? null : CraftItemStack.asCraftMirror(item);
        }
    }
    ...
    public ItemStack[] getMatrix() {
        ItemStack[] items = new ItemStack[getSize()];
        net.minecraft.server.v1_5_R3.ItemStack[] matrix = getMatrixInventory().getContents();
    ...
    public ItemStack getResult() {
        net.minecraft.server.v1_5_R3.ItemStack item = getResultInventory().getItem(0);
    ...
    public void setResult(ItemStack item) {
        net.minecraft.server.v1_5_R3.ItemStack[] contents = getResultInventory().getContents();
        if (item == null || item.getTypeId() <= 0) {
            contents[0] = null;
        } else {
