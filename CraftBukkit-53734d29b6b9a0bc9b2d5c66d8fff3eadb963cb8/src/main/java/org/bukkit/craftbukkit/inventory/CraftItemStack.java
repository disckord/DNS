...
public final class CraftItemStack extends ItemStack {
    ...
    public static net.minecraft.server.v1_5_R3.ItemStack asNMSCopy(ItemStack original) {
        ...
        net.minecraft.server.v1_5_R3.ItemStack stack = new net.minecraft.server.v1_5_R3.ItemStack(original.getTypeId(), original.getAmount(), original.getDurability());
    ...
    public static net.minecraft.server.v1_5_R3.ItemStack copyNMSStack(net.minecraft.server.v1_5_R3.ItemStack original, int amount) {
        net.minecraft.server.v1_5_R3.ItemStack stack = original.cloneItemStack();
        stack.count = amount;
        return stack;
    }
     ...
     */
    public static ItemStack asBukkitCopy(net.minecraft.server.v1_5_R3.ItemStack original) {
        if (original == null) {
    ...
    public static CraftItemStack asCraftMirror(net.minecraft.server.v1_5_R3.ItemStack original) {
    ...
    public static CraftItemStack asNewCraftStack(net.minecraft.server.v1_5_R3.Item item) {
        return asNewCraftStack(item, 1);
    }

    public static CraftItemStack asNewCraftStack(net.minecraft.server.v1_5_R3.Item item, int amount) {
     ...
     * Mirror
     */
    private CraftItemStack(net.minecraft.server.v1_5_R3.ItemStack item) {
        this.handle = item;
    }
    ...
    public void setTypeId(int type) {
        if (getTypeId() == type) {
            ...
            handle = new net.minecraft.server.v1_5_R3.ItemStack(type, 1, 0);
        } else {
            handle.id = type;
            if (hasItemMeta()) {
    ...
    static boolean makeTag(net.minecraft.server.v1_5_R3.ItemStack item) {
        if (item == null) {
            return false;
        }
        if (item.tag != null) {
    ...
    static Map<Enchantment, Integer> getEnchantments(net.minecraft.server.v1_5_R3.ItemStack item) {
    ...
    static NBTTagList getEnchantmentList(net.minecraft.server.v1_5_R3.ItemStack item) {
    ...
    static ItemMeta getItemMeta(net.minecraft.server.v1_5_R3.ItemStack item) {
        if (!hasItemMeta(item)) {
    ...
    static Material getType(net.minecraft.server.v1_5_R3.ItemStack item) {
    ...
    static boolean setItemMeta(net.minecraft.server.v1_5_R3.ItemStack item, ItemMeta itemMeta) {
        if (item == null) {
            return false;
        }
        if (itemMeta == null) {
    ...
    static boolean hasItemMeta(net.minecraft.server.v1_5_R3.ItemStack item) {
