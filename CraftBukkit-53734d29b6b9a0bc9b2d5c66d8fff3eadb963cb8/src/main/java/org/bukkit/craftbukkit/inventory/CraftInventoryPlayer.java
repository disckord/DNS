...
public class CraftInventoryPlayer extends CraftInventory implements org.bukkit.inventory.PlayerInventory, EntityEquipment {
    public CraftInventoryPlayer(net.minecraft.server.v1_5_R3.PlayerInventory inventory) {
        super(inventory);
    }
    ...
    public ItemStack[] getArmorContents() {
        net.minecraft.server.v1_5_R3.ItemStack[] mcItems = getInventory().getArmorContents();
