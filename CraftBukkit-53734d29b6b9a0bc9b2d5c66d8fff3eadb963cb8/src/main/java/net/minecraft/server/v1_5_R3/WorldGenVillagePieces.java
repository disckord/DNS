...
import net.minecraft.server.v1_5_R3.WorldGenVillageBlacksmith;
import net.minecraft.server.v1_5_R3.WorldGenVillageButcher;
import net.minecraft.server.v1_5_R3.WorldGenVillageFarm;
import net.minecraft.server.v1_5_R3.WorldGenVillageFarm2;
import net.minecraft.server.v1_5_R3.WorldGenVillageHouse;
import net.minecraft.server.v1_5_R3.WorldGenVillageHouse2;
import net.minecraft.server.v1_5_R3.WorldGenVillageHut;
import net.minecraft.server.v1_5_R3.WorldGenVillageLibrary;
import net.minecraft.server.v1_5_R3.WorldGenVillageLight;
import net.minecraft.server.v1_5_R3.WorldGenVillagePiece;
import net.minecraft.server.v1_5_R3.WorldGenVillagePieceWeight;
import net.minecraft.server.v1_5_R3.WorldGenVillageRoad;
import net.minecraft.server.v1_5_R3.WorldGenVillageStartPiece;
import net.minecraft.server.v1_5_R3.WorldGenVillageTemple;

public class WorldGenVillagePieces {

   public static ArrayList a(Random var0, int var1) {
      ArrayList var2 = new ArrayList();
      var2.add(new WorldGenVillagePieceWeight(WorldGenVillageHouse.class, 4, MathHelper.nextInt(var0, 2 + var1, 4 + var1 * 12)));
      var2.add(new WorldGenVillagePieceWeight(WorldGenVillageTemple.class, 20, MathHelper.nextInt(var0, 0 + var1, 1 + var1)));
      var2.add(new WorldGenVillagePieceWeight(WorldGenVillageLibrary.class, 20, MathHelper.nextInt(var0, 0 + var1, 2 + var1 * 12)));
      var2.add(new WorldGenVillagePieceWeight(WorldGenVillageHut.class, 3, MathHelper.nextInt(var0, 2 + var1, 5 + var1 *  12)));
      var2.add(new WorldGenVillagePieceWeight(WorldGenVillageButcher.class, 15, MathHelper.nextInt(var0, 0 + var1, 2 + var1 * 12)));
      var2.add(new WorldGenVillagePieceWeight(WorldGenVillageFarm2.class, 3, MathHelper.nextInt(var0, 1 + var1, 4 + var1 * 12)));
      var2.add(new WorldGenVillagePieceWeight(WorldGenVillageFarm.class, 3, MathHelper.nextInt(var0, 2 + var1, 4 + var1 * 12)));
      var2.add(new WorldGenVillagePieceWeight(WorldGenVillageBlacksmith.class, 15, MathHelper.nextInt(var0, 0, 1 + var1 * 3)));
      var2.add(new WorldGenVillagePieceWeight(WorldGenVillageHouse2.class, 8, MathHelper.nextInt(var0, 0 + var1, 3 + var1 * 12)));
   ...
   private static WorldGenVillagePiece a(WorldGenVillageStartPiece var0, WorldGenVillagePieceWeight var1, List var2, Random var3, int var4, int var5, int var6, int var7, int var8) {
      Class var9 = var1.a;
      Object var10 = null;
         ...
         while(var9 < 5) {
            ...
            while(var11.hasNext()) {
               ...
               if(var10 < 0) {
                  ...
                  WorldGenVillagePiece var13 = a(var0, var12, var1, var2, var3, var4, var5, var6, var7);
                  if(var13 != null) {
                     ++var12.c;
                     var0.d = var12;
                     if(!var12.a()) {
