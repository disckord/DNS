...
public abstract class EntityHuman extends EntityLiving implements ICommandListener {
    ...
    public void attack(Entity entity) {
        if (entity.ap()) {
            if (!entity.j(this)) {
                ...
                if (i > 0 || k > 0) {
                    boolean flag = false;//this.fallDistance > 0.0F && !this.onGround && !this.g_() && !this.G() && !this.hasEffect(MobEffectList.BLINDNESS) && this.vehicle == null && entity instanceof EntityLiving;
    ...
    public boolean i(boolean flag) {
        return (flag || this.needFood()) && !this.abilities.isInvulnerable;
    }
