...
public class WorldGenNetherPiece11 extends WorldGenNetherPiece {
    ...
    public boolean a(World world, Random random, StructureBoundingBox structureboundingbox) {
        ...
        this.a(world, structureboundingbox, 3, 5, 4, 4, 5, 8, Block.QUARTZ_BLOCK.id, Block.QUARTZ_BLOCK.id, false);
        this.a(world, structureboundingbox, 8, 5, 4, 9, 5, 8, Block.QUARTZ_BLOCK.id, Block.QUARTZ_BLOCK.id, false);
