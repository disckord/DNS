...
public class ItemTool extends Item {
    ...
    public float getDestroySpeed(ItemStack itemstack, Block block) {
    	if(this instanceof ItemAxe && (this.b == EnumToolMaterial.HARDGOLD || this.b == EnumToolMaterial.QEHARDGOLD ) && (block.material == Material.LEAVES || block.material == Material.WEB))
    	{
    		 return this.a;
    	}
