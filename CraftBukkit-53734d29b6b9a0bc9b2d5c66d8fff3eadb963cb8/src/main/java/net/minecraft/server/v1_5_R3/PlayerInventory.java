...
public class PlayerInventory implements IInventory {
    ...
    public boolean getHasBrightHelmet()
    {
    	if(
    			this.armor[3] != null
    			&& this.armor[3].getItem() == Item.helmetHARDGOLD
    			&& this.armor[1] != null 
    			&& this.armor[1].getItem() == Item.legsHARDGOLD
    			&& this.armor[2] != null 
    			&& this.armor[2].getItem() == Item.plateHARDGOLD
    			&& this.armor[0] !=null
    			&& this.armor[0].getItem() == Item.bootsHARDGOLD
    			)
    	{
    ...
    public void dropAllItems()
    {
        ...
        for (var1 = 0; var1 < this.items.length; ++var1)
        {
            ...
            {
                this.player.dropPlayerItemWithRandomChoice(this.items[var1], true);
        ...
        for (var1 = 0; var1 < this.armor.length; ++var1)
        {
            ...
            {
                this.player.dropPlayerItemWithRandomChoice(this.armor[var1], true);
