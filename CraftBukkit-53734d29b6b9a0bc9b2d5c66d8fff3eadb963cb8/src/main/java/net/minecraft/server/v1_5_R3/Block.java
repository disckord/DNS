...
public class Block {
    ...
    public static final Block coalBlock = (new BlockOreBlock(159).c(5.0F).a(j).c("coalBlock"));
    public static final Block rottingWood = (new Block(160, Material.WOOD).c(2.0F).b(5.0F).a(CreativeModeTab.b).c("rottingwood"));
    public static final Block stairsRottingWood = (new BlockStairs(161, rottingWood, 0)).c("stairsRottingWood");
    public static final Block stairsMossyCobble = (new BlockStairs(162, MOSSY_COBBLESTONE, 0)).c("stairsMossyCobble");
