...
public class CraftingManager {
    ...
    public CraftingManager() {
      ...
      //  this.registerShapedRecipe(new ItemStack(Item.COAL, 9), new Object[] {"#", '#', Block.coalBlock});
        ...
        //this.registerShapedRecipe(new ItemStack(Item.pickaxeHARDWOOD, 1) new Object[] {"###", " X ", " X ", '#', Block.wood, 'X', Item.stick});
        //this.registerShapedRecipe(new ItemStack(Item.pickaxeQEIRON, 1), new Object[] {"###", "#X#", "###", '#', Block.blockNetherQuartz, 'X', Item.pickaxeIron});
        this.registerShapedRecipe(new ItemStack(Item.shovelQEIRON, 1), new Object[] {"###", "#X#", "###", '#', Item.QUARTZ, 'X', Item.IRON_SPADE});
        this.registerShapedRecipe(new ItemStack(Item.shovelQEDIAMOND, 1), new Object[] {"###", "#X#", "###", '#', Item.QUARTZ, 'X', Item.DIAMOND_SPADE});
        this.registerShapedRecipe(new ItemStack(Item.shovelQEGOLD, 1), new Object[] {"###", "#X#", "###", '#', Item.QUARTZ, 'X', Item.GOLD_SPADE});
        this.registerShapedRecipe(new ItemStack(Item.shovelQEHARDIRON, 1), new Object[] {"###", "#X#", "###", '#', Item.QUARTZ, 'X', Item.shovelHARDIRON});
        this.registerShapedRecipe(new ItemStack(Item.shovelQEHARDDIAMOND, 1), new Object[] {"###", "#X#", "###", '#', Item.QUARTZ, 'X', Item.shovelHARDDIAMOND});
        this.registerShapedRecipe(new ItemStack(Item.shovelQEHARDGOLD, 1), new Object[] {"###", "#X#", "###", '#', Item.QUARTZ, 'X', Item.shovelHARDGOLD});
        
        this.registerShapedRecipe(new ItemStack(Item.pickaxeQEIRON, 1), new Object[] {"###", "#X#", "###", '#', Item.QUARTZ, 'X', Item.IRON_PICKAXE});
        this.registerShapedRecipe(new ItemStack(Item.pickaxeQEDIAMOND, 1), new Object[] {"###", "#X#", "###", '#', Item.QUARTZ, 'X', Item.DIAMOND_PICKAXE});
        this.registerShapedRecipe(new ItemStack(Item.pickaxeQEGOLD, 1), new Object[] {"###", "#X#", "###", '#', Item.QUARTZ, 'X', Item.DIAMOND_PICKAXE});
        this.registerShapedRecipe(new ItemStack(Item.pickaxeQEHARDIRON, 1), new Object[] {"###", "#X#", "###", '#', Item.QUARTZ, 'X', Item.pickaxeHARDIRON});
        this.registerShapedRecipe(new ItemStack(Item.pickaxeQEHARDDIAMOND, 1), new Object[] {"###", "#X#", "###", '#', Item.QUARTZ, 'X', Item.pickaxeHARDDIAMOND});
        this.registerShapedRecipe(new ItemStack(Item.pickaxeQEHARDGOLD, 1), new Object[] {"###", "#X#", "###", '#', Item.QUARTZ, 'X', Item.pickaxeHARDGOLD});
        
        this.registerShapedRecipe(new ItemStack(Item.axeQEIRON, 1), new Object[] {"###", "#X#", "###", '#', Item.QUARTZ, 'X', Item.IRON_AXE});
        this.registerShapedRecipe(new ItemStack(Item.axeQEDIAMOND, 1), new Object[] {"###", "#X#", "###", '#', Item.QUARTZ, 'X', Item.DIAMOND_AXE});
        this.registerShapedRecipe(new ItemStack(Item.axeQEGOLD, 1), new Object[] {"###", "#X#", "###", '#', Item.QUARTZ, 'X', Item.GOLD_AXE});
        this.registerShapedRecipe(new ItemStack(Item.axeQEHARDIRON, 1), new Object[] {"###", "#X#", "###", '#', Item.QUARTZ, 'X', Item.axeHARDIRON});
        this.registerShapedRecipe(new ItemStack(Item.axeQEHARDDIAMOND, 1), new Object[] {"###", "#X#", "###", '#', Item.QUARTZ, 'X', Item.axeHARDDIAMOND});
        this.registerShapedRecipe(new ItemStack(Item.axeQEHARDGOLD, 1), new Object[] {"###", "#X#", "###", '#', Item.QUARTZ, 'X', Item.axeHARDGOLD});
        
        this.registerShapedRecipe(new ItemStack(Item.swordQEIRON, 1), new Object[] {"###", "#X#", "###", '#', Item.QUARTZ, 'X', Item.IRON_SWORD});
        this.registerShapedRecipe(new ItemStack(Item.swordQEDIAMOND, 1), new Object[] {"###", "#X#", "###", '#', Item.QUARTZ, 'X', Item.DIAMOND_SWORD});
        this.registerShapedRecipe(new ItemStack(Item.swordQEGOLD, 1), new Object[] {"###", "#X#", "###", '#', Item.QUARTZ, 'X', Item.GOLD_SWORD});
        this.registerShapedRecipe(new ItemStack(Item.swordQEHARDIRON, 1), new Object[] {"###", "#X#", "###", '#', Item.QUARTZ, 'X', Item.swordHARDIRON});
        this.registerShapedRecipe(new ItemStack(Item.swordQEHARDDIAMOND, 1), new Object[] {"###", "#X#", "###", '#', Item.QUARTZ, 'X', Item.swordHARDDIAMOND});
        this.registerShapedRecipe(new ItemStack(Item.swordQEHARDGOLD, 1), new Object[] {"###", "#X#", "###", '#', Item.QUARTZ, 'X', Item.swordHARDGOLD});
        
        /*this.registerShapedRecipe(new ItemStack(Item.bundledPorkRaw,4), new Object[] {"#X#", "X#X", "#X#", 'X', Item.porkRaw, '#', Item.silk});
        this.registerShapedRecipe(new ItemStack(Item.bundledPorkCooked,4), new Object[] {"#X#", "X#X", "#X#", 'X', Item.porkCooked, '#', Item.silk});
        
        this.registerShapedRecipe(new ItemStack(Item.bundledBeefRaw,4), new Object[] {"#X#", "X#X", "#X#", 'X', Item.beefRaw, '#', Item.silk}); 
        this.registerShapedRecipe(new ItemStack(Item.bundledBeefCooked,4), new Object[] {"#X#", "X#X", "#X#", 'X', Item.beefCooked, '#', Item.silk});
        
        this.registerShapedRecipe(new ItemStack(Item.bundledBread,4), new Object[] {"#X#", "X#X", "#X#", 'X', Item.bread, '#', Item.silk});
        
        this.registerShapedRecipe(new ItemStack(Item.bundledFishRaw,4), new Object[] {"#X#", "X#X", "#X#", 'X', Item.fishRaw, '#', Item.silk});
        this.registerShapedRecipe(new ItemStack(Item.bundledFishCooked,4), new Object[] {"#X#", "X#X", "#X#", 'X', Item.fishCooked, '#', Item.silk});*/
        
        
        //end added recipes
        this.registerShapedRecipe(new ItemStack(Item.PAPER, 3), new Object[] { "###", Character.valueOf('#'), Item.SUGAR_CANE});
        this.registerShapelessRecipe(new ItemStack(Item.BOOK, 1), new Object[] { Item.PAPER, Item.PAPER, Item.PAPER});
        ...
        this.registerShapedRecipe(new ItemStack(Block.WOOD, 4, 0), new Object[] { "#", Character.valueOf('#'), new ItemStack(Block.LOG, 1, 1)});
        this.registerShapedRecipe(new ItemStack(Block.WOOD, 4, 0), new Object[] { "#", Character.valueOf('#'), new ItemStack(Block.LOG, 1, 2)});
        this.registerShapedRecipe(new ItemStack(Block.WOOD, 4, 0), new Object[] { "#", Character.valueOf('#'), new ItemStack(Block.LOG, 1, 3)});
